...
{
    [Serializable]
    public abstract class AbstractMaskedOperationConfig : AbstractConfig
    {
        //Mask Variables
        [Hidden]
        public bool Masked
        ...
        [SerializeField, Condition("TryingMask", true), TileDisplay] private List<int> _excludeList = new() { (int)TileDefaults.Wall_NA };
    }
}
