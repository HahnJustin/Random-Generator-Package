...
namespace Dalichrome.RandomGenerator.Configs
{
    ...
    public class InitialConfig : AbstractGeneratorConfig
    {
        ...
        [TileDisplay, LimitTileLayer(LayerType.Ground), SerializeField] private int _ground = (int)TileType.Ground_Light;

        [TileDisplay, LimitTileLayer(LayerType.Wall)] public int Wall { get { return _wall; } set { _wall = value; } }
        [TileDisplay, LimitTileLayer(LayerType.Wall), SerializeField] private int _wall = (int)TileType.Wall_Cave;
        ...
        [TileDisplay, LimitTileLayer(LayerType.Object), SerializeField] private int _containedObject = (int)TileType.Object_NA;

        [TileDisplay, LimitTileLayer(LayerType.Debug)] public int Debug { get { return _debug; } set { _debug = value; } }
        [TileDisplay, LimitTileLayer(LayerType.Debug), SerializeField] private int _debug = (int)TileType.Debug_NA;
    }
}