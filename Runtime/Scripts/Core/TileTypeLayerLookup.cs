...
namespace Dalichrome.RandomGenerator.Core
{
    public static class TileTypeLayerLookup
    {
        ...
        public static Dictionary<int, LayerType> CreateLookup()
        {
            var map = new Dictionary<int, LayerType>(64); // Initial capacity

            void Set(TileType type, LayerType layer) => map[(int)type] = layer;
