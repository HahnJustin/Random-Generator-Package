...
{
    [CreateNodeMenu("Flow/Logic Filter")]
    [NodeTint(0.33f, 0.28f, 0.33f)]
    public class LogicFilterNode : ConfigNodeBase<AbstractLogicFilterConfig>
    {
        ...
        public override System.Type ConfigBaseType => typeof(AbstractLogicFilterConfig);
